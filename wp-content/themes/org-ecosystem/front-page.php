		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-lg-6 animate-on-scroll delay-2">
					<img src="<?php echo esc_url( get_theme_mod( 'about_image', ORG_ECOSYSTEM_URI . '/assets/images/about-placeholder.png' ) ); ?>" alt="About Us" class="img-fluid rounded-4 shadow-lg">
				</div>
			</div>
		</div>
	</section>
