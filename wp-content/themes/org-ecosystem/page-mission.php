		...
		<div class="row g-5">
			<div class="col-md-6">
				<div class="mission-card p-5 bg-white shadow-sm border rounded h-100">
					...
					<p class="lead"><?php echo esc_html( get_theme_mod( 'mission_text', __( 'To empower organizations and professionals by providing a robust digital ecosystem that fosters collaboration, growth, and community engagement.', 'org-ecosystem' ) ) ); ?></p>
				</div>
			</div>
			<div class="col-md-6">
				<div class="vision-card p-5 bg-primary text-white shadow-sm border rounded h-100">
					...
					<p class="lead"><?php echo esc_html( get_theme_mod( 'vision_text', __( 'To become the global standard for organizational networking, enabling seamless member interactions and sustainable growth for all partners.', 'org-ecosystem' ) ) ); ?></p>
				</div>
			</div>
		</div>
	</div>
