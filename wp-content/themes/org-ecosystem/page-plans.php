...
<main id="primary" class="site-main py-5 bg-light">
	<div class="container">
				...
				<div class="col-lg-4 col-md-6">
					<div class="card h-100 shadow-sm border-0 pricing-card">
						...
						<div class="card-body p-4 text-center">
							...
							<div class="d-grid">
								<a href="<?php echo esc_url( add_query_arg( 'plan', $key, org_ecosystem_get_page_url( 'page-join.php' ) ) ); ?>" class="btn btn-<?php echo $key === 'premium' ? 'primary' : 'outline-primary'; ?> btn-lg fw-bold">
		...
		<div class="mt-5 text-center p-5 bg-white border rounded shadow-sm">
			...
			<a href="<?php echo org_ecosystem_get_page_url( 'page-contact.php' ); ?>" class="btn btn-link text-decoration-none fw-bold"><?php _e( 'Talk to our Sales Team', 'org-ecosystem' ); ?> <i class="bi bi-arrow-right"></i></a>
		</div>
	</div>
</main>
