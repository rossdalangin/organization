    ...
    ?>
        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="?action=support" class="btn btn-sm btn-outline-secondary">Back to Tickets</a>
            </div>
                ...
                <?php if ( $tickets->have_posts() ) : ?>
                    <?php while ( $tickets->have_posts() ) : $tickets->the_post(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="?action=support&view_ticket=<?php the_ID(); ?>" class="btn btn-sm btn-outline-primary"><?php _e( 'View', 'org-ecosystem' ); ?></a>
                            </td>
                        </tr>
