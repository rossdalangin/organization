...
<div class="payments-center">
    ...
    <div class="card border-0 shadow-sm rounded-4 p-4 bg-white">
        ...
        <a href="?action=edit-profile" class="btn btn-link p-0 text-decoration-none small"><?php _e( 'Update payout details in Profile settings', 'org-ecosystem' ); ?> <i class="bi bi-arrow-right"></i></a>
    </div>
</div>
